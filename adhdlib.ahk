...
Class ADHDLib {
	...
	*/
	...
	create_gui(){
		...
		Gui, Add, Tab2, x0 w%w% h%h% vadhd_current_tab gadhd_tab_changed, Bindings

		local tabtop := 40
		local current_row := tabtop + 20
		
		local nexttab := this.private.tab_list.MaxIndex()
		Gui, Tab, %nexttab%
		; BINDINGS TAB
	...
	*/
	...
	minimize_app() {
		return this.private.minimize_app()
	}
...
Class ADHD_Private {
	...
	__New(){
		...
		this.author_macro_name := "Overkeys"				; Change this to your macro name
